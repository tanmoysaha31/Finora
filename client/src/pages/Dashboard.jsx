...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen w-screen antialiased selection:bg-purple-500 selection:text-white overflow-hidden" style={{ backgroundColor: '#1a1a1a', color: 'white' }}>
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full blur-[100px] opacity-15" style={{ background: '#7c3aed' }}></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full blur-[100px] opacity-15" style={{ background: '#2563eb' }}></div>
        <div className="absolute top-[40%] left-[40%] w-[400px] h-[400px] rounded-full blur-[100px] opacity-10" style={{ background: '#d946ef' }}></div>
      </div>

      <aside className={`w-72 ${mobileOpen ? 'flex' : 'hidden'} lg:flex flex-col justify-between p-6 border-r border-white/5 bg-[#1a1a1a]/95 backdrop-blur-xl fixed h-full z-40 transition-all`}>
        <div>
          ...
          <div className="purple-card-gradient rounded-3xl p-6 mb-8 shadow-xl relative">
      ...
      <div className="flex-1 lg:ml-72 flex flex-col h-full relative z-10">
        <header className="px-4 py-2 md:px-6 md:py-3 lg:px-8 lg:py-3 flex flex-col md:flex-row justify-between items-center gap-2 bg-[#1a1a1a]/80 backdrop-blur-md sticky top-0 z-20 border-b border-white/5">
          ...
          <div className="relative w-full md:w-96">
            <input value={search} onChange={(e)=>setSearch(e.target.value)} type="text" placeholder="Search transactions, bills..." className="w-full bg-[#242424] border border-white/10 text-gray-300 rounded-full py-3.5 pl-12 pr-4 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:bg-[#2a2a2a] placeholder:text-gray-600 text-sm font-medium" />
        ...
        <main className="flex-1 overflow-hidden p-2 md:p-3">
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-2 lg:gap-3">
              <div className="xl:col-span-2 space-y-2.5">
                <div className="glass-panel rounded-3xl p-5 md:p-6 relative overflow-hidden">
                ...
                <div className="glass-panel rounded-3xl p-2 md:p-2.5">
              ...
              <div className="space-y-2 lg:space-y-3">
                <div className="glass-panel rounded-3xl p-3 md:p-4">
                  ...
                  <div className="space-y-1.5 overflow-y-auto pr-2 max-h-[420px] scrollbar-hide">
                    {((data?.transactions || []).filter(t => {
                      ...
                      return (
                        <div key={tx.id}>
                          <div className="flex items-center justify-between p-2.5 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-lg bg-[#2a2a2a] flex items-center justify-center text-gray-400">
                                <i className={`fa-solid ${icon} text-sm`}></i>
                              </div>
                              <div className="min-w-0">
                                <div className="text-xs md:text-sm font-bold text-white">{tx.title}</div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button className="w-7 h-7 rounded-lg bg-white/5 text-gray-400">
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-1">
                    {(data?.contacts || []).map(c => (
                      <div key={c.id} className="flex flex-col items-center gap-2 min-w-[70px]">
                        <div className="w-14 h-14 rounded-full border-2 border-dashed border-gray-600 p-[3px] flex items-center justify-center">
                    ...
                    <div className="flex flex-col items-center gap-2 min-w-[70px]">
                      <div className="w-14 h-14 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-gray-400">
